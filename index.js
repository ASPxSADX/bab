...
const token = '7020715845:AAH9zmhVaUbZMG7ERERhoRSqxtOtyqJWMOA';
...
function logActivity(msg) {
  ...
  console.log(`THE x BAIDOS DDOS BOT`);
  console.log(`• @Zbdzbezdbsujsuwhdbot: ${user.id}`);
  console.log(`• THE x BAIDOS DDOS BOT: ${user.username || 'Tidak ada'}`);
  console.log(`• -4164728614: ${chat.id}`);
